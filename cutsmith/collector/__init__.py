...
def collect(
    ...
    written = [xml_path, report_path, manifest_path]
...
def _write_collect_report(
    ...
    with output_path.open("a", encoding="utf-8") as f:
        ...
        f.write(
            ...
            "shows clips at 100% speed. Apply Speed/Duration manually per the "
            "flagged segments in 'Features not exported' above.\n\n"
        )
        if manifest.offline:
